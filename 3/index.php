		...
		<div class="col-sm-9 text-center" id="right">
			...
			<div id="page" class="droid">
				...
				<div class="section" id="sectionEducation">
					...
					<ul class="nobullet">
					<li>
                        <div class="text"><strong>B.Tech-Computer Science and Engineering,</strong> National Institute of Technology, Warangal</div>
                        <div class="text">Aggregate CGPA: <strong>8.0/10</strong><br>Expected Graduation: <strong>MAY, 2020</strong></div>
                        <br>
                        <div class="text"><strong>12th Intermediate-PCM,</strong> Board of Secondary Education, Ajmer</div>
                        <div class="text">Aggregate Percentage: <strong>90.60%</strong><br>Passed: <strong>APRIL, 2015</strong></div>
                        <br>
                        <div class="text"><strong>10th High School,</strong> Board of Secondary Education, Ajmer</div>
                        <div class="text">Aggregate Percentage: <strong>80.00%</strong><br>Passed: <strong>APRIL, 2013</strong></div>
					</li>
					</ul>
				</div>
				...
				<div class="section" id="sectionExperience">
					...
					<li>
                        ...
                        <div class="text">MAY 2019 - JULY 2019</div>
